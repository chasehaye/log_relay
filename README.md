...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project---backend">About The Project - Frontend</a>
      <ul>
...
Follow these steps to set up the backend locally for development.

### Prerequisites

Docker -> `latest` (recommended)
<br />
Go version -> `1.21+` (optional, for local development)
<br />
PostgreSQL version -> `14+` (optional, for local development)

### Front-End Setup

This project interfaces with a corresponding frontend.

👉 Please follow the setup instructions in the frontend repository:
https://github.com/chasehaye/fude_software_front


### Back-End Setup

Set-up instructions can be found in the Development.md file in this projects directory.

There is also a corresponding manual and openAPI syntax for the implemented API.
